    ...
    <section className="space-y-16 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <p className="text-slate-300 text-lg leading-relaxed">
          I am a backend engineer focused on building reliable, production-ready
          systems. I care deeply about clean architecture, data integrity, and
          software that behaves predictably under real-world conditions.
        </p>
      </div>

      {/* Background */}
      <div className="space-y-6">
        <h2 className="text-xl font-semibold">Background & Training</h2>
